...
public class CategoryController {
    ...
    //all categories
    @GetMapping
    ResponseEntity<Page<Category>> getAll(@RequestParam(value = "PageNumber",defaultValue = DefaultValues.PAGE_NUMBER,required = false) int pageNumber,
    ...
    {
        return ResponseEntity.ok(service.getAll(pageNumber,pageSize,sortBy));
    }
